      ...
      <div className="divide-y divide-border/50">
        ...
        <div className="flex items-center justify-between px-4 py-3 transition-colors hover:bg-muted/30">
          <div className="flex items-center gap-3">
            ...
            <div>
              <div className="text-sm font-medium">
                {t("settings.skillInsightAutoGenerate")}
              </div>
              <div className="mt-0.5 text-xs text-muted-foreground">
                {t("settings.skillInsightAutoGenerateDesc")}
              </div>
            </div>
          </div>
          <label className="inline-flex cursor-pointer items-center gap-2 text-xs text-muted-foreground">
            <input
              type="checkbox"
              checked={skillInsightAutoGenerateEnabled}
              onChange={(event) =>
                onSkillInsightAutoGenerateChange(event.target.checked)
              }
