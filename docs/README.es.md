<div align="center">
  ...
  <p>
    ...
    <a href="https://github.com/tianzecn/SkillsHub/releases"><img src="https://img.shields.io/badge/version-v0.5.10-green?style=flat-square" alt="Versión"/></a>
...
### Última versión v0.5.10 (2026-05-04) 🎉

**Actualización automática**

- 🔁 **Corrección del bucle del diálogo de actualización**: tras detectar una nueva versión, las comprobaciones en segundo plano ya no interrumpen la copia de seguridad, la descarga ni la instalación, y el diálogo no vuelve a “Checking”
- 📥 **Conservación del estado de descarga**: el progreso y el estado descargado ignoran eventos de comprobación tardíos, y la entrada superior de actualización puede reabrir el flujo de instalación
