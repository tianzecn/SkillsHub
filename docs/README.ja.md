...
### 最新バージョン v0.5.8 (2026-05-04) 🎉

**自動更新**

- 🔄 **更新チェックの停止状態を修正**：IPC で結果が返っても updater イベントが届かない場合、ダイアログが戻り値の状態でフォールバックします
- ⏱️ **更新ソースのタイムアウト対応**：ネットワーク、プロキシ、更新ソースが長時間応答しない場合、30 秒後に明確なエラー状態へ移行します
