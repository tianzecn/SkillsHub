...
### 最新バージョン v0.7.0 (2026-05-13) 🎉

**Skill Store AI インサイト**

- 🧠 **インストール前 AI インサイト**：Skill Store はインポート前に推奨度、能力概要、適用/非適用シーン、質問例、リスク、根拠を生成します
- 🧩 **コンパクトな一覧体験**：ストア行は個別コピーできるテスト質問例を保持し、注意事項と根拠は詳細画面で確認できます
