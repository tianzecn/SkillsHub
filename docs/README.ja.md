...
### 最新バージョン v0.5.11 (2026-05-04) 🎉

**自動更新**

- 🔁 **更新ダイアログのループ修正**：新バージョン検出後、バックグラウンド確認がバックアップ、ダウンロード、インストールを中断せず、ダイアログも「確認中」に戻りません
- 📥 **ダウンロード状態の保持**：ダウンロード進捗とダウンロード済み状態は遅れて届いた確認イベントを無視し、閉じた後も上部の更新入口から再開できます
