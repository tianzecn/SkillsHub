...
Download the latest version v0.8.0 from [Releases](https://github.com/tianzecn/SkillsHub/releases):
...
### Latest Version v0.8.0 (2026-05-13) 🎉

**Installed Skill AI Insights**

- 🧠 **My Skills detail insights**: Imported Skills now keep recommendation, capability summary, fit/non-fit scenarios, and prompt examples above the description
- 🔁 **Store cache reuse**: Importing from the store reuses generated insights for the same `SKILL.md` instead of calling AI again
