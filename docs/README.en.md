...
Download the latest version v0.9.0 from [Releases](https://github.com/tianzecn/SkillsHub/releases):
...
- [x] **Skill AI search**: My Skills and the Skill Store can rerank results from the query, candidate summaries, and cached AI insights
- [x] **Online skill discovery**: Specific searches can expand from the local list or store into the skills.sh community source
- [x] **Insight-aware matching**: Search includes capability summaries, fit scenarios, trigger guidance, and prompt examples
- [x] **Full SKILL.md sync**: Local repo sync preserves complete content for stable hashes and insight-cache reuse
...
### Latest Version v0.9.0 (2026-05-13) 🎉

**Skill AI Search and Online Discovery**

- 🔎 **Semantic reranking**: My Skills and the Skill Store match better skills by combining the query, candidate summaries, and cached AI insights
- 🌐 **Online expansion**: Low-confidence or manual searches can continue into the skills.sh community source
...
- **Issues**: [GitHub Issues](https://github.com/tianzecn/SkillsHub/issues)
...
- All the amazing [contributors](https://github.com/tianzecn/SkillsHub/graphs/contributors) who helped improve PromptHub!
