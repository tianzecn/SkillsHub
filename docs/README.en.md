...
Download the latest version v0.5.6 from [Releases](https://github.com/tianzecn/PromptHub/releases):
...
### Latest Version v0.5.6 (2026-04-24) 🎉
...
- 🌍 **Docs and localized release sync**: README, localized docs, and website release metadata are aligned to `v0.5.6`
...
- **Issues**: [GitHub Issues](https://github.com/tianzecn/PromptHub/issues)
...
- All the amazing [contributors](https://github.com/tianzecn/PromptHub/graphs/contributors) who helped improve PromptHub!
