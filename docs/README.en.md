...
Download the latest version v0.5.8 from [Releases](https://github.com/tianzecn/SkillsHub/releases):
...
### Latest Version v0.5.8 (2026-05-04) 🎉

**Auto Update**

- 🔄 **Update check stuck state fix**: When the update check returns through IPC but the updater event is missed, the dialog now falls back to the returned status
- ⏱️ **Update source timeout fallback**: Slow network, proxy, or update source failures now surface after 30 seconds instead of leaving the dialog on “Checking”
