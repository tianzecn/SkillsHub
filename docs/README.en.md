...
Download the latest version v0.5.7 from [Releases](https://github.com/tianzecn/SkillsHub/releases):
...
### Latest Version v0.5.7 (2026-05-04) 🎉

**Community Skill Store**

- 🧩 **SkillsHub remote store integration**: The desktop Skill Store now includes an API-backed skills.sh / SkillsHub community source with Trending, search, official curated lists, and detail file loading
- 🔑 **Community source API key setting**: Skill settings now include an optional masked skills.sh API key; anonymous usage still works with clear degraded / rate-limit status

**Safety & Release**

- 🛡️ **Community Skill install safety boundary**: A dedicated main-process skills.sh service and typed IPC keep remote requests on allowlisted endpoints, with safety scanning and duplicate filtering before install
- 📦 **Download link and release metadata fix**: Linux deb links now match the CI artifact `PromptHub-0.5.7-amd64.deb`, keeping Release assets and download buttons aligned
