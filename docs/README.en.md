<div align="center">
  ...
  <p>
    ...
    <a href="https://github.com/tianzecn/SkillsHub/releases"><img src="https://img.shields.io/badge/version-v0.7.0-green?style=flat-square" alt="Version"/></a>
...
Download the latest version v0.7.0 from [Releases](https://github.com/tianzecn/SkillsHub/releases):
...
- [x] **Pre-install AI Skill insights**: The Skill Store analyzes complete `SKILL.md` content before import and returns recommended / caution / not-recommended guidance
- [x] **Dedicated Skill insight AI scenario**: Added the `skillInsight` AI usage scenario with separate model selection, background generation, content-hash cache, and manual refresh
- [x] **Compact store insight rows**: Store rows now show structured decisions, fit/non-fit scenarios, and individually copyable test prompts
...
### Latest Version v0.7.0 (2026-05-13) 🎉

**Skill Store AI Insights**

- 🧠 **Pre-install AI insights**: Skill Store import decisions now include recommendations, capability summaries, fit/non-fit scenarios, prompt examples, risks, and evidence
- 🧩 **Compact list experience**: Store rows now keep individually copyable test prompts, while notes and evidence remain available in the detail view
