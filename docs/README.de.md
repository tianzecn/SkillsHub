<div align="center">
  ...
  <p>
    ...
    <a href="https://github.com/tianzecn/SkillsHub/releases"><img src="https://img.shields.io/badge/version-v0.5.9-green?style=flat-square" alt="Version"/></a>
...
### Neueste Version v0.5.9 (2026-05-04) 🎉

**Auto-Update-Verifizierung**

- 🔖 **Testversion für den Auto-Update-Pfad**: Nach dem `v0.5.8`-Fix für hängende Update-Prüfungen veröffentlicht diese höhere stabile Version einen vollständigen Test von „Update erkennen → herunterladen → installieren“
- 🧪 **Verifizierung der Release-Quelle**: Nutzt weiterhin GitHub Releases und `latest*.yml`-Feeds von `tianzecn/SkillsHub`, damit der stabile Kanal die neue Version erkennen kann
