...
### Neueste Version v0.6.0 (2026-05-10) 🎉

**Skill Store / WebDAV**

- 🧩 **Hermes Agent Skill-Quellen**: Der Skill Store enthält nun integrierte Hermes Agent- und Hermes Optional-Remote-Quellen und unterstützt GitHub-Unterverzeichnis-Repositories mit `SKILL.md`
- ☁️ **WebDAV Upload-Diagnose**: Upload-Fehler zeigen jetzt den echten Statuscode und Hinweise zu Schreibrechten; Verbindungstests behandeln Weiterleitungen nicht mehr als nutzbare WebDAV-Endpunkte
