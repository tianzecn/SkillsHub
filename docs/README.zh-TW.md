...
從 [Releases](https://github.com/tianzecn/SkillsHub/releases) 下載最新版本 v0.5.8：
...
### 最新版本 v0.5.8 (2026-05-04) 🎉

**自動更新**

- 🔄 **更新檢查卡住修復**：檢查更新已透過 IPC 返回但 updater 事件未送達時，彈窗會使用返回狀態兜底
- ⏱️ **更新源逾時兜底**：網路、代理或更新源長時間無回應時，30 秒後會進入明確錯誤狀態，不再一直停留在「檢查中」
