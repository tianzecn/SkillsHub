...
從 [Releases](https://github.com/tianzecn/SkillsHub/releases) 下載最新版本 v0.8.0：
...
- [x] **已安裝 Skill AI 解讀**：我的 Skills 詳情頁會在技能描述上方顯示與商店詳情一致的結構化 AI 解讀
- [x] **匯入時復用商店解讀**：商店中已產生且內容匹配的解讀會帶入已安裝 Skill，避免重複消耗 token
- [x] **本地內容兜底產生**：沒有可復用快取時，已安裝 Skill 可基於完整本地 `SKILL.md` 手動或自動產生解讀
...
### 最新版本 v0.8.0 (2026-05-13) 🎉

**已安裝 Skill AI 解讀**

- 🧠 **我的 Skills 詳情解讀**：匯入後在詳情頁技能描述上方繼續展示推薦判斷、核心能力、適用/不適用場景和提問範例
- 🔁 **商店快取復用**：從商店匯入時復用已產生解讀，避免同一份 `SKILL.md` 重複呼叫 AI
