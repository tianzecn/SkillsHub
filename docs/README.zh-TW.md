...
從 [Releases](https://github.com/tianzecn/SkillsHub/releases) 下載最新版本 v0.7.0：
...
- 🧠 **安裝前 AI 解讀**：Skill 商店在匯入前產生三檔建議、能力摘要、適用/不適用場景、提問範例、風險與依據
- 🧩 **列表體驗優化**：商店改為緊湊列表列，保留可逐條複製的測試提問範例，詳情頁繼續提供注意事項和依據
