...
從 [Releases](https://github.com/tianzecn/SkillsHub/releases) 下載最新版本 v0.5.11：
...
### 最新版本 v0.5.11 (2026-05-04) 🎉

**自動更新**

- 🔁 **更新彈窗循環修復**：發現新版本後，背景自動檢查不再插隊打斷備份、下載或安裝流程，彈窗也不會反覆跳回「檢查中」
- 📥 **下載狀態保持**：下載進度與已下載狀態會忽略遲到的檢查事件，關閉彈窗後仍可從頂部更新入口繼續安裝
