<div align="center">
  ...
  *Prompt 管理 · 技能商店 · 多平台分发 · 版本控制 · 变量模板 · 多模型测试 — 一站式 AI 工作台*
  ...
  [![Version](https://img.shields.io/badge/version-v0.5.11-success?style=for-the-badge)](https://github.com/tianzecn/SkillsHub/releases)
...
从 [Releases](https://github.com/tianzecn/SkillsHub/releases) 下载最新版本 v0.5.11：
...
- 🔁 **更新弹窗循环修复**：发现新版本后，后台自动检查不再插队打断备份、下载或安装流程，弹窗也不会重复跳回“检查中”
- 📥 **下载状态保持**：下载进度和已下载状态会忽略迟到的检查事件，关闭弹窗后仍可从顶部更新入口继续安装
